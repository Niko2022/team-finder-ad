...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        if created1:
            ...
            user1.save()
            self.stdout.write(
                self.style.SUCCESS("✅ Создан: Дмитрий Козлов (dmitry@example.com)")
            )
        ...
        if created2:
            ...
            user2.save()
            self.stdout.write(
                self.style.SUCCESS("✅ Создан: Анна Смирнова (anna@example.com)")
            )
        ...
        if created3:
            ...
            user3.save()
            self.stdout.write(
                self.style.SUCCESS("✅ Создан: Максим Петров (maxim@example.com)")
            )
        ...
        if created_p1:
            ...
            self.stdout.write(
                self.style.SUCCESS("✅ Создан проект: TeamFinder Platform")
            )
        ...
        if created_p2:
            ...
            self.stdout.write(
                self.style.SUCCESS("✅ Создан проект: E-commerce Dashboard")
            )
