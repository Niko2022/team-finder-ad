...
class ProfileEditForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            ...
            'about': forms.Textarea(attrs={'class': 'form-textarea', 'placeholder': 'Расскажите о себе...', 'rows': 4}),
            'phone': forms.TextInput(attrs={'class': 'form-input', 'placeholder': '+7 (999) 000-00-00'}),
